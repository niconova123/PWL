...
<div style="clear: both; width:200px;margin-right:12px" class="pull-right">
    <form action="index.php?p=sekolah&m=search">
        ...
        <input autocomplete="off" type="text" name="q" id="" placeholder="Type and enter to search value" value="<?php echo(get("q"));?>">
        ...
        <?php
            ...
            foreach ($data as $key){
                ...
                <tr>
                    ...
                    <td><img class="mini-img"src="assets/img/<?php echo $key['logo'];?>"></td>
